...
const AllTask = () => {
   ...
   const sortedEmployees = userData ? [...userData].sort((a, b) => b.taskCounts.completed - a.taskCounts.completed) : [];

  return (
    <div className='bg-[#1c1c1c] p-5 rounded mt-5'>
        <div className='bg-red-400 mb-2 py-2 px-4 flex justify-between rounded font-bold'>
            <h2 className='text-lg w-1/5'>Rank & Name</h2>
        ...
        <div>
        {sortedEmployees.map(function(elem, idx){
            return <div key={idx} className='border-2 border-emerald-500 mb-2 py-2 px-4 flex justify-between rounded'>
            <h2 className='text-lg font-medium w-1/5'>#{idx+1} {elem.firstName}</h2>
